...
while True:
    ...
    if r.status_code==200:
        ...
        break
##插入数据库
# conn=MySQLdb.connect(host='127.0.0.1',user='root',password='123456',charset='utf8')
# cur=conn.cursor()
# sql='insert into scrpay.weibo(comment_id,user_name,created_at,text,likenum,source) values(%s,%s,%s,%s,%s,%s)'
# param=(comment_id,user_name,created_at,text,likenum,source)
# try:
#     A = cur.execute(sql,param)
#     conn.commit()
